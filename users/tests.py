...
class UserRegistrationTestCase(TestCase):
    def test_user_register_view(self):
        ...
        self.assertContains(response, 'Account created for newuser. Please Log in', html=True)
    ...
    def test_messages_after_registration(self):
        ...
        self.assertEqual(str(messages[0]), 'Account created for newuser. Please Log in')
